        ...
        <View style={style.container}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={style.containerNavegacao}>
                    ...
                    <Text style={style.textNavegacao} onPress={AbrilPerfilSeguindo}>Lista de pessoas</Text>


                    <TouchableOpacity>
                        <Text style={style.textNavegacao} onPress={AbrilPerfilConquista}>Cardápio</Text>
                    </TouchableOpacity>
                </View>
